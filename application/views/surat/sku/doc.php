...
$document = file_get_contents("assets/format_surat/format_keterangan_usaha.rtf");
...
$document = str_replace("[pddk_pekerjaan]", $pemohon['pekerjaan'], $document);
$document = str_replace("[pddk_agama]", $pemohon['agama'], $document);
$document = str_replace("[pddk_alamat]", $pemohon['alamat'], $document);

// Data surat
$document = str_replace("[pddk_bidang]", $surat['bidang_usaha'], $document);
$document = str_replace("[usaha_alamat]", $surat['alamat_usaha'], $document);
...
header("Content-disposition: inline; filename=SKU.doc");
