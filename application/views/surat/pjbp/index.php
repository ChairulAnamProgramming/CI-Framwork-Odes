                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="form-group">
                              <label class="col-sm-6 control-label">Masukkan Nik (Penjual)</label>
                              <div class="col-sm-6">
                                  <input type="text" class="form-control" placeholder="exm:6307040406110002" id="nik_penjual" name="nik_penjual">
                                  <?= form_error('nik_penjual', '<small class="text-error text-danger">', '</small>'); ?>
                                  <br>
                              </div>
                              <label class="col-sm-6 control-label">Umur (Penjual)</label>
                              <div class="col-sm-6">
                                  <input type="number" class="form-control" id="umur_penjual" name="umur_penjual">
                                  <?= form_error('umur_penjual', '<small class="text-error text-danger">', '</small>'); ?>
                                  <br>
                              </div>
                              <label class="col-sm-6 control-label">Masukkan Nik (Pembeli)</label>
                              <div class="col-sm-6">
                                  <input type="text" class="form-control" placeholder="exm:6307040406110002" id="nik_pembeli" name="nik_pembeli">
                                  <?= form_error('nik_pembeli', '<small class="text-error text-danger">', '</small>'); ?>
                                  <br>
                              </div>
                              <label class="col-sm-6 control-label">Umur (Pembeli)</label>
                              <div class="col-sm-6">
                                  <input type="number" class="form-control" id="umur_pembeli" name="umur_pembeli">
                                  <?= form_error('umur_pembeli', '<small class="text-error text-danger">', '</small>'); ?>
                                  <br>
                              </div>
          ...
          <script type="text/javascript">
              $('#nik_penjual').on('input',()=>{
                 const pemohon = $('#nik_penjual').val()
